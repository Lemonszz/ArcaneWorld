...
public class TeleporterDungeon extends Teleporter
{
    ...
    public void placeEntity(World world, Entity entity, float yaw)
    {
        ...
        entity.setLocationAndAngles(offsetPos.getX() + (DungeonGenerator.ROOM_WIDTH / 2), offsetPos.up(2).getY(), offsetPos.getZ() + (DungeonGenerator.ROOM_WIDTH / 2), entity.rotationYaw, 0.0F);
        entity.motionX = 0.0D;
        entity.motionY = 0.0D;
        entity.motionZ = 0.0D;
    }
