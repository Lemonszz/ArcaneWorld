package party.lemons.arcaneworld.entity.ai;
 ...
 */
public class EntityAiEatGrassFaster extends EntityAIEatGrass
{
    ...
    public EntityAiEatGrassFaster(EntityLiving grassEaterEntityIn)
    {
